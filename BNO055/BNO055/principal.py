...
BAUD_RATE = 115200
DURACION_CAPTURA_S =  int(input("por cuanto tiempo deseas grabar esta prueba: "))  # tiempo de captura por corrida (segundos)

# ejercicio que quieres medir en ESTA ejecución:
# "fe" = Flex/Ext; "ur" = Ulnar/Radial; "ps" = Prono/Sup
EJERCICIO_ACTUAL = str(input("escoge tu ejercicio: "))
...
def capturar_rom_desde_arduino(puerto, ejercicio, duracion_s, baud=115200):
    ...
    if ejercicio == "1":
        ...
        ser.close()
        raise ValueError("Ejercicio inválido: usa '1', '2' o '3'.")
